...
<template>
  <v-layout>
    <v-app-bar :elevation="1">
      ...
      <v-img
        src="https://www.schadensmeldung.digital/images/Logo-Schadensmeldung.digital-dunkel.svg"
        alt="Logo"
        max-height="40"
      ></v-img>
    </v-app-bar>
    ...
    <v-navigation-drawer v-model="drawer">
      <v-list nav>
        ...
        <v-list-item title="Damage Process" link to="/damageprocess"></v-list-item>
      </v-list>
    </v-navigation-drawer>
